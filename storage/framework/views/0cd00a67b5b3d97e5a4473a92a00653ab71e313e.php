...
<div class="register-box">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <a href="<?php echo e(route('login.create')); ?>" class="text-center">I already have a membership</a>
        </div>
        <!-- /.form-box -->
    </div><!-- /.card -->
</div>
...
<?php /**PATH D:\OSPanel\domains\engboss\resources\views/user/create.blade.php ENDPATH**/ ?>