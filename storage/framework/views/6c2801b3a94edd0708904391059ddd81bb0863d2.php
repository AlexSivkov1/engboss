...
<div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
    <div class="card card-blog">
        <div class="card-blog__img align-self-center">
            <a href="<?php echo e(route('products.single', ['slug'=>$product->slug])); ?>"><img class="img-fluid" style="width: 340px;height: 280px" src="<?php echo e($product->getImage()); ?>"  alt=""></a>
        ...
        <div class="card-body align-self-center">
            ...
            <?php endif; ?>
            <?php if($product->sale): ?>
                <p style="line-height:0.5px " class=""></p><img style="width: 30px; height: 25px; margin: 0 auto" src="<?php echo e(asset('assets/front/img/sale.png')); ?>" alt="">
            <?php endif; ?>
            ...
            <div class="item-status"><i class="<?php echo e($product->status->icon); ?>" style="color: #00e765"></i> <?php echo e($product->status->title); ?></div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\engboss\resources\views/product/index.blade.php ENDPATH**/ ?>