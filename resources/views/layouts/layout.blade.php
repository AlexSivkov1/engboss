...
<head>
    ...
    <title>@yield('title', 'EngBoss')</title>
    <link rel="icon" href="{{asset('assets/front/img/Fevicon.png')}}" type="image/png">
    ...
    <link rel="stylesheet" href="{{asset('assets/front/vendors/nice-select/nice-select.css')}}">
...
<header class="header_area">
    ...
    <div class="main_menu">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand logo_h" href="{{route('home')}}"><img src="{{asset('assets/front/img/logo.png')}}" alt=""></a>
                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{route('categories')}}">Shop Category</a>
                                </li>

                                <li class="nav-item"><a class="nav-link" href="single-product.html">Product Details</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('products') }}">Product Checkout</a></li>
                                <li class="nav-item"><a class="nav-link" href="confirmation.html">Confirmation</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('cart.show')}}">Shopping Cart</a></li>
                            </ul>
                        </li>
                        <li class="nav-item submenu dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="{{route('test')}}">Test English</a></li>
                            </ul>
                        </li>
                        <li class="nav-item submenu dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="single-footer-widget instafeed">
                        ...
                        <ul class="list instafeed d-flex flex-wrap">
                            <li><img src="{{asset('assets/front/img/gallery/r1.jpg')}}" alt=""></li>
                            <li><img src="{{asset('assets/front/img/gallery/r2.jpg')}}" alt=""></li>
                            <li><img src="{{asset('assets/front/img/gallery/r3.jpg')}}" alt=""></li>
                            <li><img src="{{asset('assets/front/img/gallery/r5.jpg')}}" alt=""></li>
                            <li><img src="{{asset('assets/front/img/gallery/r7.jpg')}}" alt=""></li>
                            <li><img src="{{asset('assets/front/img/gallery/r8.jpg')}}" alt=""></li>
                        </ul>
                    </div>
                </div>
...
<script src="{{asset('assets/front/vendors/nice-select/jquery.nice-select.min.js')}}"></script>
<script src="{{asset('assets/front/vendors/jquery.ajaxchimp.min.js')}}"></script>
