        ...
        <div class="row s_product_inner">
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    <h2>{{$product->price}}</h2>
                    <ul class="list">
                        <li><a class="active" href="{{route('categories.single',[ 'slug'=>$product->category->slug])}}"><span>Category : </span> {{$product->category->title}}</a></li>
                        <li><a href="#"><span>Availibility</span><i class="{{ $product->status->icon }}" style="color: darkred"></i> : {{$product->status->title}}</a></li>
